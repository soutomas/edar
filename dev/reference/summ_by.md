...
#> Adding missing grouping variables: `name`
#> # A tibble: 9 × 12
#>   name      n   nNA   Mean      SD GeoMean GeoCV   Min    P25 Median    P75
#>   <chr> <int> <int>  <dbl>   <dbl>   <dbl> <dbl> <dbl>  <dbl>  <dbl>  <dbl>
#> 1 carb     32     0   2.81   1.62     2.40 64.4   1      2      2      4   
#> 2 cyl      32     0   6.19   1.79     5.92 31.7   4      4      6      8   
#> 3 disp     32     0 231.   124.     197.   64.3  71.1  121.   196.   326   
#> 4 drat     32     0   3.60   0.535    3.56 14.9   2.76   3.08   3.70   3.92
#> 5 gear     32     0   3.69   0.738    3.62 19.6   3      3      4      4   
#> 6 hp       32     0 147.    68.6    132.   50.3  52     96.5  123    180   
#> 7 mpg      32     0  20.1    6.03    19.3  30.4  10.4   15.4   19.2   22.8 
#> 8 qsec     32     0  17.8    1.79    17.8   9.98 14.5   16.9   17.7   18.9 
#> 9 wt       32     0   3.22   0.978    3.07 32.6   1.51   2.58   3.32   3.61
...
#> Adding missing grouping variables: `name`
#> # A tibble: 9 × 10
#>   name      n   nNA   Mean      SD   Min   P10 Median    P90    Max
#>   <chr> <int> <int>  <dbl>   <dbl> <dbl> <dbl>  <dbl>  <dbl>  <dbl>
...
#> # A tibble: 4 × 11
#> # Groups:   vs [2]
#>   vs    am        n   nNA  Mean    SD   Min   P25 Median   P75   Max
...
#> Adding missing grouping variables: `vs`
#> # A tibble: 2 × 19
#>   vs    mpg_n mpg_nNA mpg_Mean mpg_SD mpg_Min mpg_P25 mpg_Median mpg_P75 mpg_Max
#>   <fct> <int>   <int>    <dbl>  <dbl>   <dbl>   <dbl>      <dbl>   <dbl>   <dbl>
#> 1 0        18       0     16.6   3.86    10.4    14.8       15.6    19.1    26  
#> 2 1        14       0     24.6   5.38    17.8    21.4       22.8    29.6    33.9
#> # ℹ 9 more variables: disp_n <int>, disp_nNA <int>, disp_Mean <dbl>,
#> #   disp_SD <dbl>, disp_Min <dbl>, disp_P25 <dbl>, disp_Median <dbl>,
#> #   disp_P75 <dbl>, disp_Max <dbl>
d |> summ_by(c(mpg,disp),vs,xname="mpg_")
#> Adding missing grouping variables: `vs`
#> # A tibble: 2 × 19
#>   vs        n   nNA  Mean    SD   Min   P25 Median   P75   Max disp_n disp_nNA
...
#> #   disp_P25 <dbl>, disp_Median <dbl>, disp_P75 <dbl>, disp_Max <dbl>
...
#> #   cyl_SD <dbl>, cyl_Min <dbl>, cyl_P25 <dbl>, cyl_Median <dbl>,
#> #   cyl_P75 <dbl>, cyl_Max <dbl>, disp_n <int>, disp_nNA <int>,
#> #   disp_Mean <dbl>, disp_SD <dbl>, disp_Min <dbl>, disp_P25 <dbl>,
#> #   disp_Median <dbl>, disp_P75 <dbl>, disp_Max <dbl>, hp_n <int>,
#> #   hp_nNA <int>, hp_Mean <dbl>, hp_SD <dbl>, hp_Min <dbl>, hp_P25 <dbl>,
#> #   hp_Median <dbl>, hp_P75 <dbl>, hp_Max <dbl>, drat_n <int>, …
```
